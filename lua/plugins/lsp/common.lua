...
M.key.keys = {
    {
        'g', '+ LSP actions',
        {
            ...
            { 'n', 'rr', ':IncRename ' .. vim.fn.expand('<cword>'), 'Rename', expr = true, has_method = 'rename' },
            { 'n', 'rR', Util.lsp.rename_file, 'Rename File', has_method = { 'workspace/willRenameFiles', 'workspace/didRenameFiles' } },
