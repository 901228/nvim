return {
    -- to indicate buffers
    {
        ...
        event = 'VeryLazy',
        keys = {
            { '<leader>bd', function() require('util').bufremove() end, desc = 'Close Buffer' },
        ...
        opts = {
            options = {
                ...
                middle_mouse_command = function(n) require('util').bufremove(n) end,
                close_command = function(n) require('util').bufremove(n) end,
            }
        },
