...
-- This function resolve nested placeholders in a snippet
---@param snippet string
---@return string
...
function M.auto_brackets(entry)
    ...
    if vim.tbl_contains({ Kind.Function, Kind.Method }, item.kind) then
        ...
        local prev_char = vim.api.nvim_buf_get_text(0, cursor[1] - 1, cursor[2], cursor[1], cursor[2] + 1, {})[1]
...
-- This is a better implementation of `cmp.confiom`
